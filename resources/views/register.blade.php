    ...
    <body class="font-sans text-gray-100 antialiased">
        <div class="min-h-screen flex flex-col items-center justify-center pt-6 sm:pt-0 px-4">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-4xl font-bold bg-gradient-to-r from-purple-400 to-indigo-600 bg-clip-text text-transparent">
                    Create Profile
                </h1>
                <p class="text-gray-400 mt-2 font-medium">Step into the cave of sparks 💜</p>
            </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-6 p-4 bg-gray-900/50 rounded-xl border border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-200 mb-4 flex items-center">
                            <span class="mr-2">💑</span>Dating Profile
                        </h3>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" 
                            class="w-full bg-royal-gradient text-white font-bold py-3 px-4 rounded-xl shadow-lg shadow-royal-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300">
                        Begin Your Journey
                    </button>
